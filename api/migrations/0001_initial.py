# Generated by Django 3.2.2 on 2021-06-30 17:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img1', models.CharField(blank=True, default='https://ibb.co/k6Wv1mX', max_length=200)),
                ('img2', models.CharField(blank=True, default='https://ibb.co/k6Wv1mX', max_length=200)),
                ('img3', models.CharField(blank=True, default='https://ibb.co/k6Wv1mX', max_length=200)),
                ('img4', models.CharField(blank=True, default='https://ibb.co/k6Wv1mX', max_length=200)),
