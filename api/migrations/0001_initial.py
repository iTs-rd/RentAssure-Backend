# Generated by Django 3.2.2 on 2021-06-10 10:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastname', models.CharField(blank=True,
                 default='Not Available', max_length=32, null=True)),
                ('mobile', models.CharField(blank=True, max_length=10, null=True)),
                ('dp', models.ImageField(blank=True,
                 default='images/dp/default.jpg', upload_to='images/dp/')),
                ('age', models.CharField(blank=True,
                 default='Not Available', max_length=3, null=True)),
                ('gender', models.CharField(blank=True, choices=[
                 ('Male', 'Male'), ('Female', 'Female'), ('Other', 'Other')], default='Not available', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(max_length=60, validators=[api.models.WhitelistEmailValidator(
                    whitelist=['gmail.com', 'yahoo.com', 'hotmail.com', 'outlook.com'])])),
                ('mobile', models.CharField(max_length=10, validators=[django.core.validators.RegexValidator(re.compile(
                    '^\\d+(?:\\ \\d+)*\\Z'), code='invalid', message=None), django.core.validators.MinLengthValidator(10)], verbose_name='Phone Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.CharField(choices=[
                 ('Flat', 'Flat'), ('Room', 'Room'), ('House', 'House')], max_length=5)),
                ('title', models.CharField(max_length=32)),
                ('img1', models.ImageField(blank=True,
                 default='images/default/1.jpg', upload_to='images/product/')),
                ('img2', models.ImageField(blank=True,
                 default='images/default/2.jpg', upload_to='images/product/')),
                ('img3', models.ImageField(blank=True,
                 default='images/default/3.jpg', upload_to='images/product/')),
                ('img4', models.ImageField(blank=True,
                 default='images/default/4.jpg', upload_to='images/product/')),
                ('description', models.TextField(max_length=360)),
                ('bhk', models.CharField(blank=True, choices=[('1RK/1BHK', '1RK/1BHK'), ('2BHK', '2BHK'), ('3BHK', '3BHK'), (
                    '4BHK', '4BHK'), ('4BHK', '4BHK'), ('5+BHK', '5+BHK'), ('No', 'No')], max_length=10, null=True)),
                ...
                ('cleaning', models.CharField(blank=True, choices=[
                 ('No', 'No'), ('Daily', 'Daily'), ('Weekly', 'Weekly')], default='No', max_length=6)),
                ('furnished', models.CharField(choices=[('Unfurnished', 'Unfurnished'), ('SemiFurnished', 'Semifurnished'), (
                    'FullyFurnished', 'Fullyfurnished')], default='Unfurnished', max_length=20)),
                ('available_for', models.CharField(blank=True, choices=[('Student', 'Student'), ('GovernmentEmployee', 'GovernmentEmployee'), (
                    'Bachelor', 'Bachelor'), ('Couple', 'Couple'), ('Family', 'Family'), ('Boy', 'Boy'), ('Girl', 'Girl'), ('Any', 'Any')], default='Any', max_length=20)),
                ...
                ('agreement_duration', models.IntegerField(
                    blank=True, default=12, null=True)),
                ...
                ('posted_by', models.CharField(choices=[
                 ('Owner', 'Owner'), ('Agent', 'Agent')], max_length=5)),
