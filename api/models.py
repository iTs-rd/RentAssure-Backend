...
class Data(models.Model):
    ...
    img1 = models.ImageField(upload_to='images/data/',
                             default='images/data/default.png', verbose_name="")
    ...
    available_for = models.CharField(
        max_length=10, choices=AVAILABLE_FOR_CHOICES, default='any', blank=True)
...
class ContactData(models.Model):
    ...
    detail = models.TextField(max_length=32, blank=False)
